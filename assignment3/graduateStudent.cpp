...
void graduateStudent::calculateGPA() {
    ...
    switch (getCS677LetterGrade()) {
        case 'A': cs677GradePoint = 4.0; break;
        case 'B': cs677GradePoint = 3.0; break;
        case 'C': cs677GradePoint = 2.0; break;
        case 'D': cs677GradePoint = 1.0; break;
        case 'F': cs677GradePoint = 0.0; break;
    }
