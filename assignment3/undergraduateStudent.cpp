...
void undergraduateStudent::calculateGPA() {
    ...
    switch (getCS135LetterGrade()) {
        case 'A': cs135GradePoint = 4.0; break;
        case 'B': cs135GradePoint = 3.0; break;
        case 'C': cs135GradePoint = 2.0; break;
        case 'D': cs135GradePoint = 1.0; break;
        case 'F': cs135GradePoint = 0.0; break;
    }

    switch (getCS202LetterGrade()) {
        case 'A': cs202GradePoint = 4.0; break;
        case 'B': cs202GradePoint = 3.0; break;
        case 'C': cs202GradePoint = 2.0; break;
        case 'D': cs202GradePoint = 1.0; break;
        case 'F': cs202GradePoint = 0.0; break;
    }
